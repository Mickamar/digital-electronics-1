...
begin
  ...
  begin
    ...
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "0100"; -- Some default value
    wait for 50 ns;
    
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "0101"; -- Some default value
    wait for 50 ns;
    
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "0110"; -- Some default value
    wait for 50 ns;
    
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "0111"; -- Some default value
    wait for 50 ns;
    
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "1000"; -- Some default value
    wait for 50 ns;
    ...
    sig_blank <= '0';    -- Normal operation
    sig_hex   <= "1001"; -- Some default value
    wait for 50 ns;
